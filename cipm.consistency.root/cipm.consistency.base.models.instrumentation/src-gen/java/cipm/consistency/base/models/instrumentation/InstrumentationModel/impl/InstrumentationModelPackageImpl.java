...
public class InstrumentationModelPackageImpl extends EPackageImpl implements InstrumentationModelPackage {
	 ...
	 * @see dmodel.base.models.inmodel.InstrumentationMetamodel.InstrumentationModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * {@link InstrumentationModelPackage#eINSTANCE} when that field is accessed.
	...
	public static InstrumentationModelPackage init() {
		if (isInited)
			return (InstrumentationModelPackage) EPackage.Registry.INSTANCE
					.getEPackage(InstrumentationModelPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredInstrumentationModelPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		InstrumentationModelPackageImpl theInstrumentationModelPackage = registeredInstrumentationModelPackage instanceof InstrumentationModelPackageImpl
				? (InstrumentationModelPackageImpl) registeredInstrumentationModelPackage
				: new InstrumentationModelPackageImpl();
	...
	public void createPackageContents() {
		...
		createEReference(serviceInstrumentationPointEClass,
				SERVICE_INSTRUMENTATION_POINT__ACTION_INSTRUMENTATION_POINTS);
	...
	public void initializePackageContents() {
		...
		initEClass(instrumentationModelEClass, InstrumentationModel.class, "InstrumentationModel", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getInstrumentationModel_Points(), this.getServiceInstrumentationPoint(), null, "points", null, 0,
				-1, InstrumentationModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(serviceInstrumentationPointEClass, ServiceInstrumentationPoint.class, "ServiceInstrumentationPoint",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getServiceInstrumentationPoint_Service(), theSeffPackage.getResourceDemandingSEFF(), null,
				"service", null, 1, 1, ServiceInstrumentationPoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getServiceInstrumentationPoint_ActionInstrumentationPoints(),
				this.getActionInstrumentationPoint(), null, "actionInstrumentationPoints", null, 0, -1,
				ServiceInstrumentationPoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(instrumentationPointEClass, InstrumentationPoint.class, "InstrumentationPoint", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getInstrumentationPoint_Active(), ecorePackage.getEBoolean(), "active", null, 0, 1,
				InstrumentationPoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(actionInstrumentationPointEClass, ActionInstrumentationPoint.class, "ActionInstrumentationPoint",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getActionInstrumentationPoint_Action(), theSeffPackage.getAbstractAction(), null, "action", null,
				1, 1, ActionInstrumentationPoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getActionInstrumentationPoint_Type(), this.getInstrumentationType(), "type", null, 1, 1,
				ActionInstrumentationPoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
