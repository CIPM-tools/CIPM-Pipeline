...
public class InstrumentationModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case InstrumentationModelPackage.INSTRUMENTATION_MODEL: {
			...
			if (result == null)
				result = caseIdentifier(instrumentationModel);
			if (result == null)
		...
		case InstrumentationModelPackage.SERVICE_INSTRUMENTATION_POINT: {
			...
			if (result == null)
				result = caseInstrumentationPoint(serviceInstrumentationPoint);
			if (result == null)
				result = caseIdentifier(serviceInstrumentationPoint);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case InstrumentationModelPackage.INSTRUMENTATION_POINT: {
			...
			if (result == null)
				result = caseIdentifier(instrumentationPoint);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case InstrumentationModelPackage.ACTION_INSTRUMENTATION_POINT: {
			...
			if (result == null)
				result = caseInstrumentationPoint(actionInstrumentationPoint);
			if (result == null)
				result = caseIdentifier(actionInstrumentationPoint);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * '<em>Instrumentation Model</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of
	 *         '<em>Instrumentation Model</em>'.
	 ...
	 * Instrumentation Point</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Service
	 *         Instrumentation Point</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	...
	/**
	 * Returns the result of interpreting the object as an instance of
	 * '<em>Instrumentation Point</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of
	 *         '<em>Instrumentation Point</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	...
	/**
	 * Returns the result of interpreting the object as an instance of
	 * '<em>Identifier</em>'. <!-- begin-user-doc --> This implementation returns
