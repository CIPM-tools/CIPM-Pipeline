...
public class InstrumentationModelFactoryImpl extends EFactoryImpl implements InstrumentationModelFactory {
	...
	public static InstrumentationModelFactory init() {
		try {
			InstrumentationModelFactory theInstrumentationModelFactory = (InstrumentationModelFactory) EPackage.Registry.INSTANCE
					.getEFactory(InstrumentationModelPackage.eNS_URI);
