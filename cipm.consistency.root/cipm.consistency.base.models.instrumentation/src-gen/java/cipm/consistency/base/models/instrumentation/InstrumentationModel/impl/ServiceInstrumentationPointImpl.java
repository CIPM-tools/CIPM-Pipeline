 ...
 * </p>
 * <ul>
 * <li>{@link dmodel.base.models.inmodel.InstrumentationMetamodel.impl.ServiceInstrumentationPointImpl#getService
 * <em>Service</em>}</li>
 * <li>{@link dmodel.base.models.inmodel.InstrumentationMetamodel.impl.ServiceInstrumentationPointImpl#getActionInstrumentationPoints
 * <em>Action Instrumentation Points</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ServiceInstrumentationPointImpl extends InstrumentationPointImpl implements ServiceInstrumentationPoint {
	...
	/**
	 * The cached value of the '{@link #getActionInstrumentationPoints() <em>Action
	 * Instrumentation Points</em>}' containment reference list. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
			...
			if (service != oldService) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							InstrumentationModelPackage.SERVICE_INSTRUMENTATION_POINT__SERVICE, oldService, service));
			}
		}
		return service;
	}
	...
	public EList<ActionInstrumentationPoint> getActionInstrumentationPoints() {
		if (actionInstrumentationPoints == null) {
			actionInstrumentationPoints = new EObjectContainmentEList<ActionInstrumentationPoint>(
					ActionInstrumentationPoint.class, this,
					InstrumentationModelPackage.SERVICE_INSTRUMENTATION_POINT__ACTION_INSTRUMENTATION_POINTS);
		}
