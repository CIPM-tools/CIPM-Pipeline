 ...
 * '<em><b>Instrumentation Model</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link dmodel.base.models.inmodel.InstrumentationMetamodel.impl.InstrumentationModelImpl#getPoints
 * <em>Points</em>}</li>
 * </ul>
 *
 * @generated
...
public class InstrumentationModelImpl extends IdentifierImpl implements InstrumentationModel {
	...
	public EList<ServiceInstrumentationPoint> getPoints() {
		if (points == null) {
			points = new EObjectContainmentEList<ServiceInstrumentationPoint>(ServiceInstrumentationPoint.class, this,
					InstrumentationModelPackage.INSTRUMENTATION_MODEL__POINTS);
		}
		return points;
	}
