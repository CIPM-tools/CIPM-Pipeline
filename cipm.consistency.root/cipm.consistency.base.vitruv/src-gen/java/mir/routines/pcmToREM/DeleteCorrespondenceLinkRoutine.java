...
public class DeleteCorrespondenceLinkRoutine extends AbstractRepairRoutineRealization {
  ...
  protected boolean executeRoutine() throws IOException {
    ...
    cipm.consistency.base.models.runtimeenvironment.REModel.RuntimeResourceContainerConnection corr = getCorrespondingElement(
    	userExecution.getCorrepondenceSourceCorr(link), // correspondence source supplier
    	cipm.consistency.base.models.runtimeenvironment.REModel.RuntimeResourceContainerConnection.class,
    	(cipm.consistency.base.models.runtimeenvironment.REModel.RuntimeResourceContainerConnection _element) -> true, // correspondence precondition checker
    	null, 
    	false // asserted
    	);
    if (corr == null) {
