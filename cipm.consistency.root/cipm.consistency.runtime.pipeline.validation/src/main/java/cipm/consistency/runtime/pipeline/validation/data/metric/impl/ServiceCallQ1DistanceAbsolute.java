...
@Service
public class ServiceCallQ1DistanceAbsolute extends ServiceCallMetric {
	...
	public DoubleMetricValue calculate(ValidationPoint point) {
		if (point.getAnalysisDistribution() != null && point.getMonitoringDistribution() != null) {
			if (point.getAnalysisDistribution().getYValues().size() >= 1
				...
				Percentile q1 = new Percentile(0.25);
				...
				return new DoubleMetricValue(distance, ValidationMetricType.Q1_DISTANCE, false);
			}
		}
		return null;
	}
