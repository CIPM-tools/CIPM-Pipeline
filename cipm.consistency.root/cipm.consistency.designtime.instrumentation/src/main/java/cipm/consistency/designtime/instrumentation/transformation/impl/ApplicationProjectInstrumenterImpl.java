...
import cipm.consistency.designtime.instrumentation.transformation.impl.sub.BranchActionInstrumenter;
import cipm.consistency.designtime.instrumentation.transformation.impl.sub.ExternalCallInstrumenter;
import cipm.consistency.designtime.instrumentation.transformation.impl.sub.InternalActionInstrumenter;
import cipm.consistency.designtime.instrumentation.transformation.impl.sub.LoopActionInstrumenter;
import cipm.consistency.designtime.instrumentation.transformation.impl.sub.ServiceCallInstrumenter;
