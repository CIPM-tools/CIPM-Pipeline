package cipm.consistency.designtime.instrumentation.mapping;

import java.util.Optional;
import java.util.regex.Matcher;
import java.util.regex.Pattern;

import cipm.consistency.designtime.instrumentation.mapping.comment.AbstractMappingComment;
import cipm.consistency.designtime.instrumentation.mapping.comment.BranchMappingComment;
import cipm.consistency.designtime.instrumentation.mapping.comment.ExternalCallMappingComment;
import cipm.consistency.designtime.instrumentation.mapping.comment.InternalActionMappingComment;
import cipm.consistency.designtime.instrumentation.mapping.comment.LoopMappingComment;
