...
public class REModelAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link dmodel.pipeline.rt.runtimeenvironment.REModel.RuntimeEnvironmentModel <em>Runtime Environment Model</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link dmodel.pipeline.rt.runtimeenvironment.REModel.HardwareInformation <em>Hardware Information</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
