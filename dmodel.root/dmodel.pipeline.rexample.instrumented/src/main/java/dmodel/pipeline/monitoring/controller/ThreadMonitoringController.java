...
public class ThreadMonitoringController {
    ...
    private void registerInstrumentationModelPoll() {
        execService.scheduleAtFixedRate(() -> pollInstrumentationModel(), 15, 15, TimeUnit.SECONDS);
    }
