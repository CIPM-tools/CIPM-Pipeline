...
public class CPUSamplingJob implements ISampler {
    ...
    public void sample(IMonitoringController arg0) throws Exception {
        ...
        ResourceUtilizationRecord util = new ResourceUtilizationRecord(hostId, hostName, MonitoringMetadata.RESOURCE_CPU, cpuPerc, CPUSamplingJob.TIME_SOURCE.getTime());
