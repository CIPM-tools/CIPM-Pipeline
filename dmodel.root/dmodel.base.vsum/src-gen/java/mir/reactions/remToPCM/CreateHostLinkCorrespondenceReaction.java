...
public class CreateHostLinkCorrespondenceReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    dmodel.base.models.runtimeenvironment.REModel.RuntimeResourceContainerConnection affectedEObject = createChange.getAffectedEObject();
  ...
  private boolean matchCreateChange(final EChange change) {
    if (change instanceof CreateEObject<?>) {
    	CreateEObject<dmodel.base.models.runtimeenvironment.REModel.RuntimeResourceContainerConnection> _localTypedChange = (CreateEObject<dmodel.base.models.runtimeenvironment.REModel.RuntimeResourceContainerConnection>) change;
    	...
    	this.createChange = (CreateEObject<dmodel.base.models.runtimeenvironment.REModel.RuntimeResourceContainerConnection>) change;
    	return true;
    }
