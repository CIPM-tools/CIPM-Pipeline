...
public class DeleteHostCorrespondenceReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    dmodel.base.models.runtimeenvironment.REModel.RuntimeResourceContainer affectedEObject = deleteChange.getAffectedEObject();
  ...
  private boolean matchDeleteChange(final EChange change) {
    if (change instanceof DeleteEObject<?>) {
    	DeleteEObject<dmodel.base.models.runtimeenvironment.REModel.RuntimeResourceContainer> _localTypedChange = (DeleteEObject<dmodel.base.models.runtimeenvironment.REModel.RuntimeResourceContainer>) change;
    	if (!(_localTypedChange.getAffectedEObject() instanceof dmodel.base.models.runtimeenvironment.REModel.RuntimeResourceContainer)) {
    		return false;
    	}
    	this.deleteChange = (DeleteEObject<dmodel.base.models.runtimeenvironment.REModel.RuntimeResourceContainer>) change;
    	return true;
    }
