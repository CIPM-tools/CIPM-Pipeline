...
public class DeleteHostLinkCorrespondenceReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    dmodel.base.models.runtimeenvironment.REModel.RuntimeResourceContainerConnection affectedEObject = deleteChange.getAffectedEObject();
  ...
  private boolean matchDeleteChange(final EChange change) {
    if (change instanceof DeleteEObject<?>) {
    	DeleteEObject<dmodel.base.models.runtimeenvironment.REModel.RuntimeResourceContainerConnection> _localTypedChange = (DeleteEObject<dmodel.base.models.runtimeenvironment.REModel.RuntimeResourceContainerConnection>) change;
    	if (!(_localTypedChange.getAffectedEObject() instanceof dmodel.base.models.runtimeenvironment.REModel.RuntimeResourceContainerConnection)) {
    		return false;
    	}
    	this.deleteChange = (DeleteEObject<dmodel.base.models.runtimeenvironment.REModel.RuntimeResourceContainerConnection>) change;
    	return true;
    }
