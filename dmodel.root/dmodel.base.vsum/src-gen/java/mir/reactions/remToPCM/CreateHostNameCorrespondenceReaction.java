...
public class CreateHostNameCorrespondenceReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    dmodel.base.models.runtimeenvironment.REModel.RuntimeResourceContainer affectedEObject = createChange.getAffectedEObject();
  ...
  private boolean matchCreateChange(final EChange change) {
    if (change instanceof CreateEObject<?>) {
    	CreateEObject<dmodel.base.models.runtimeenvironment.REModel.RuntimeResourceContainer> _localTypedChange = (CreateEObject<dmodel.base.models.runtimeenvironment.REModel.RuntimeResourceContainer>) change;
    	...
    	this.createChange = (CreateEObject<dmodel.base.models.runtimeenvironment.REModel.RuntimeResourceContainer>) change;
    	return true;
    }
