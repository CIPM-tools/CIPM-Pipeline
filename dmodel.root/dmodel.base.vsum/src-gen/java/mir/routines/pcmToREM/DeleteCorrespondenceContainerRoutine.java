...
public class DeleteCorrespondenceContainerRoutine extends AbstractRepairRoutineRealization {
  ...
  protected boolean executeRoutine() throws IOException {
    ...
    dmodel.base.models.runtimeenvironment.REModel.RuntimeResourceContainer corr = getCorrespondingElement(
    	userExecution.getCorrepondenceSourceCorr(container), // correspondence source supplier
    	dmodel.base.models.runtimeenvironment.REModel.RuntimeResourceContainer.class,
    	(dmodel.base.models.runtimeenvironment.REModel.RuntimeResourceContainer _element) -> true, // correspondence precondition checker
    	null, 
    	false // asserted
    	);
    if (corr == null) {
