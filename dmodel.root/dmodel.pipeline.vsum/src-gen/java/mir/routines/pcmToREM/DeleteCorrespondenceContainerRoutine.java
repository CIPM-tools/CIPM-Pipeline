...
public class DeleteCorrespondenceContainerRoutine extends AbstractRepairRoutineRealization {
  ...
  protected boolean executeRoutine() throws IOException {
    ...
    dmodel.pipeline.rt.runtimeenvironment.REModel.RuntimeResourceContainer corr = getCorrespondingElement(
    	userExecution.getCorrepondenceSourceCorr(container), // correspondence source supplier
    	dmodel.pipeline.rt.runtimeenvironment.REModel.RuntimeResourceContainer.class,
    	(dmodel.pipeline.rt.runtimeenvironment.REModel.RuntimeResourceContainer _element) -> true, // correspondence precondition checker
    	null, 
    	false // asserted
    	);
    if (corr == null) {
