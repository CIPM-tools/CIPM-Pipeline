...
public class DeleteCorrespondenceLinkRoutine extends AbstractRepairRoutineRealization {
  ...
  protected boolean executeRoutine() throws IOException {
    ...
    dmodel.pipeline.rt.runtimeenvironment.REModel.RuntimeResourceContainerConnection corr = getCorrespondingElement(
    	userExecution.getCorrepondenceSourceCorr(link), // correspondence source supplier
    	dmodel.pipeline.rt.runtimeenvironment.REModel.RuntimeResourceContainerConnection.class,
    	(dmodel.pipeline.rt.runtimeenvironment.REModel.RuntimeResourceContainerConnection _element) -> true, // correspondence precondition checker
    	null, 
    	false // asserted
    	);
    if (corr == null) {
