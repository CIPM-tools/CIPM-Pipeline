...
public class CreateHostLinkCorrespondenceReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    dmodel.pipeline.rt.runtimeenvironment.REModel.RuntimeResourceContainerConnection affectedEObject = createChange.getAffectedEObject();
  ...
  private boolean matchCreateChange(final EChange change) {
    if (change instanceof CreateEObject<?>) {
    	CreateEObject<dmodel.pipeline.rt.runtimeenvironment.REModel.RuntimeResourceContainerConnection> _localTypedChange = (CreateEObject<dmodel.pipeline.rt.runtimeenvironment.REModel.RuntimeResourceContainerConnection>) change;
    	...
    	this.createChange = (CreateEObject<dmodel.pipeline.rt.runtimeenvironment.REModel.RuntimeResourceContainerConnection>) change;
    	return true;
    }
